...
const I18n = {
  ...
  STR: {
    ja: {
      ...
      noCallTarget: (label) => `「${label}」の相手が設定されていません。設定で入力してください。`,
      notifySending: 'LINEで送信中…',
      notifySent: 'LINEで家族に知らせました',
      notifyFailed: 'LINEへの通知に失敗しました',
    ...
    en: {
      ...
      startTips: [
        ...
        'Keeping both eyes closed returns to the start screen.',
      ],
      yes: 'Yes',
      no: 'No',
      stop: 'Stop',
      ...
      noCallTarget: (label) => `No contact set for “${label}”. Enter one in Settings.`,
      notifySending: 'Sending via LINE…',
      notifySent: 'Notified your family via LINE',
      notifyFailed: 'Failed to notify via LINE',
  ...
  SETTING_LABEL: {
    ...
    call1Target:       { ja: '電話 1 の相手（メールアドレス・電話番号）', en: 'Call 1 contact (email or phone)' },
    call2Target:       { ja: '電話 2 の相手（メールアドレス・電話番号）', en: 'Call 2 contact (email or phone)' },
    notifyUrl:        { ja: '助けて通知の送信先URL', en: 'Help notify endpoint URL' },
    notifyKey:        { ja: '助けて通知のキー', en: 'Help notify key' },
    maxFreezeMs:      { ja: '選択が止まる上限 (ms)', en: 'Max highlight freeze (ms)' },
    closedEyesReturnMs: { ja: '両目を閉じたらスタートにもどる (ms)', en: 'Return to start when eyes closed (ms)' },
